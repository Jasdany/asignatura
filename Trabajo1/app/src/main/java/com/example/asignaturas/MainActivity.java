...
public class MainActivity extends AppCompatActivity {
    ListView mylist;
    List<String> Asignatura = new ArrayList<String>(Arrays.asList("Formulacion y gestio de proyectos", "Facultativa II", "Investigacion aplicada"));
    ...
    void add(String asignatura) {
        if(!asignatura.isEmpty())
        {
            ...
            Toast.makeText(this, "Añadir asignatura", Toast.LENGTH_SHORT).show();
        }
    }
